...
4. Use (Node.js)[https://github.com/nodejs/node] (more complex), or type in `python3 -m http.server` if you have Python 3 installed, or `python -m simple-http-server` if you have Python 2 or below installed (any version of Python is much easier).
